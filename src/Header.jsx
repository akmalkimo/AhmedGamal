        ...
        <nav>
            <div className="mobileNavWrapper" id="#">
                ...
                <div className="cvMenuWrapper">
                    <a href="/ahmeds-portfolio/AhmedGamalCV.pdf" download="Ahmed Gamal's CV">
            ...
            <h1><a href="#" className="name cursive">Ahmed Gamal.</a></h1>
                <a href="/ahmeds-portfolio/AhmedGamalCV.pdf" download="Ahmed Gamal's CV" className="cvWrapper">
